...
import { FaExternalLinkAlt, FaGithub, FaSpa, FaShieldAlt, FaMotorcycle, FaRecycle } from 'react-icons/fa';
    ...
    <section className="bg-[#0a0a0a] py-20 px-6 md:px-12 lg:px-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-14 text-center">
          <p className="text-gray-500 text-xs font-medium uppercase tracking-widest mb-3">Work</p>
            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                {project.technologies.map((tech) => (
                  <span key={tech} className="text-xs text-gray-400 border border-[#252525] rounded-md px-2.5 py-1">
                    {tech}
                  </span>
                ))}
              </div>
